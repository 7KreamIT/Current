...
const string fileName = "Справка.csv"; //имя файла для ввода			//устарело
const string fileNameOut = "Справка-Out.csv"; //имя файла для вывода	//оставить до решения с выводом
